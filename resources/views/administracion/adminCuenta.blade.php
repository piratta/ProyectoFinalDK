        ...
        @foreach ($cuentas as $accs)    
            ...
            <tr>
                ...
                <button class="borrar">
                     ...
                     <form method="post" action="borrarAcc"><input value="<?=  $accs -> id  ?>" Type="hidden" name="id" id="'<?=  $accs -> id  ?>'"/>
                @csrf
               ...
               <form  method="post" action="editar" >
                        ...
                        <button class="bEdit" data-id="{{  $accs -> id  }}" type="button" data-toggle="modal" data-target="#modify">
                            <input type="hidden" id="{{  $accs -> id  }}" name="id_mod" value="{{  $accs -> id  }}"/>
...
@include('administracion.insertarC')

@include('administracion.modificarC')
